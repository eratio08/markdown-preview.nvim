...
const LOG_FILE_PATH = process.env.NVIM_MKDP_LOG_FILE || node_path_1.default.join(node_os_1.default.tmpdir(), 'mkdp-nvim.log');
const level = process.env.NVIM_MKDP_LOG_LEVEL || 'info';
if (level === 'debug') {
    node_fs_1.default.writeFileSync(LOG_FILE_PATH, '', 'utf8');
}
